"""
--> This file consists the code for training object-centric model.
--> Just change the 'env_id' argument to train it for different games.
"""
...
if __name__ == "__main__":
    ...
    run_name = f"{args.env_id}__OBJ_SLOT_FW_10M{args.exp_name}__{args.seed}__{int(time.time())}"
    if args.track:
        import wandb
            ...
            if "final_info" in infos:
                for info in infos["final_info"]:
                    if info and "episode" in info:
                        ...
                        # writer.add_histogram("histogram/action_histogram", actions, global_step)
