"""
This file consists the code for node aggregation experiment for Space Invaders environment.
...
if __name__ == "__main__":
    ...
    model_file = os.path.join(args.model_path, 'node_aggr_SPI_10M')
    run_name = f"{args.env_id}__node_aggr_SPI_10M{args.exp_name}__{args.seed}__{int(time.time())}"
    if args.track:
        import wandb
