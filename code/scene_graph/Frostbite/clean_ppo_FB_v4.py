...
-->Best scene graph model implementation.
-->Base implementation for other experiments.
...
if __name__ == "__main__":
    ...
    model_file = os.path.join(args.model_path, 'GCN_Clean_FB_single_file_v4_10M')
    run_name = f"{args.env_id}__GCN__FB__single_file_v4{args.exp_name}__{args.seed}__{int(time.time())}"
    if args.track:
        import wandb
